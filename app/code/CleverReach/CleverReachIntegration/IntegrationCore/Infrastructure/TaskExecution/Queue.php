...
namespace CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\TaskExecution;
 ...
 * Class Queue
 *
 * @package CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\TaskExecution
 */
class Queue
{
     ...
     *
     * @return \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\TaskExecution\QueueItem
     *   Created queue item.
     *
     ...
     * @throws Exceptions\QueueStorageUnavailableException
     * @throws \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\TaskExecution\Exceptions\QueueItemDeserializationException
     */
    public function start(QueueItem $queueItem)
    {
        ...
        } catch (\CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpAuthenticationException $exception) {
    ...
    public function finish(QueueItem $queueItem)
    {
        ...
        try {
            ...
            throw new QueueStorageUnavailableException(
                'Unable to finish task. Queue storage failed to save item.',
                0,
                $exception
            );
        }
    ...
    public function requeue(QueueItem $queueItem)
    {
        ...
        try {
            ...
            throw new QueueStorageUnavailableException(
                'Unable to requeue task. Queue storage failed to save item.',
                0,
                $exception
            );
        }
    ...
    public function fail(QueueItem $queueItem, $failureDescription)
    {
        ...
        try {
            ...
            throw new QueueStorageUnavailableException(
                'Unable to fail task. Queue storage failed to save item.',
                0,
                $exception
            );
        }
    ...
    public function updateProgress(QueueItem $queueItem, $progress)
    {
        ...
        try {
            ...
            throw new QueueStorageUnavailableException(
                'Unable to update task progress. Queue storage failed to save item.',
                0,
                $exception
            );
        }
    ...
    public function keepAlive(QueueItem $queueItem)
    {
        ...
        try {
            ...
            throw new QueueStorageUnavailableException(
                'Unable to keep task alive. Queue storage failed to save item.',
                0,
                $exception
            );
        }
