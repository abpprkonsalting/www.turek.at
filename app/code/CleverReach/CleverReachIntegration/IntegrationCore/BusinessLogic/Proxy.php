...
namespace CleverReach\CleverReachIntegration\IntegrationCore\BusinessLogic;

use CleverReach\CleverReachIntegration\IntegrationCore\BusinessLogic\DTO\RecipientDTO;
...
use CleverReach\CleverReachIntegration\IntegrationCore\BusinessLogic\Utility\Helper;
use CleverReach\CleverReachIntegration\IntegrationCore\BusinessLogic\Utility\Rule;
 ...
 * Class Proxy
 *
 * @package CleverReach\CleverReachIntegration\IntegrationCore\BusinessLogic
 */
class Proxy implements ProxyInterface
{
    ...
    public function registerEventHandler($eventParameters)
    {
        ...
        } catch (\CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpAuthenticationException $e) {
        } catch (\CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpCommunicationException $e) {
        } catch (\CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpRequestException $e) {
        }
     ...
     *   * verify: token for URL verification
     *
     * @return \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\HttpResponse|null
    ...
    public function createGlobalAttribute($attribute)
    {
        try {
            ...
            $result = json_decode($response->getBody(), true);
        } catch (\CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpRequestException $ex) {
     ...
     *
     * @param array $recipients Array of objects @see \CleverReach\CleverReachIntegration\IntegrationCore\BusinessLogic\DTO\RecipientDTO
     *
     * @throws \InvalidArgumentException
     * @throws \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Exceptions\InvalidConfigurationException
     * @throws \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpAuthenticationException
     * @throws \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpBatchSizeTooBigException
     * @throws \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpCommunicationException
     * @throws \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpRequestException
     * @throws \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\RefreshTokenExpiredException
     */
     ...
     *
     * @param RecipientDTO[] $recipientDTOs Array of objects @see \CleverReach\CleverReachIntegration\IntegrationCore\BusinessLogic\DTO\RecipientDTO
     *
     * @return array
     ...
     *
     * @param \CleverReach\CleverReachIntegration\IntegrationCore\BusinessLogic\Entity\TagCollection|null $recipientTags Existing tags.
     * @param \CleverReach\CleverReachIntegration\IntegrationCore\BusinessLogic\Entity\TagCollection|null $tagsForDelete Tags for delete.
     *
     * @return array
     ...
     *
     * @param \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpRequestException $ex Exception object.
    ...
    private function checkMassUpdateBatchSizeValidity($ex, $batchSize)
    {
        if ($ex->getCode() === self::HTTP_STATUS_CODE_NOT_SUCCESSFUL_FOR_DEFINED_BATCH_SIZE) {
            ...
            throw new \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpBatchSizeTooBigException(
    ...
    public function getUserInfo($accessToken)
    {
        ...
        } catch (\CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpAuthenticationException $ex) {
    ...
    public function call($method, $endpoint, $body = [], $accessToken = '')
    {
        ...
        if (empty($accessToken)) {
            ...
            throw new \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpCommunicationException($errorMessage);
        }
     ...
     *
     * @throws \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpCommunicationException
     * @throws \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Exceptions\BadAuthInfoException
     */
    public function getAuthInfo($code, $redirectUrl)
    {
        ...
        if (isset($result['error'])
            ...
            throw new \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Exceptions\BadAuthInfoException(
    ...
    protected function validateResponse($response)
    {
        ...
        if ($httpCode !== null && ($httpCode < 200 || $httpCode >= 300)) {
            ...
            if ($httpCode === self::HTTP_STATUS_CODE_UNAUTHORIZED || $httpCode === self::HTTP_STATUS_CODE_FORBIDDEN) {
                ...
                throw new \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpAuthenticationException(
                    $message,
                    $httpCode
                );
            }
     ...
     *
     * @return \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\HttpResponse
    ...
    private function getValidAccessToken($token)
    {
        if (empty($token)) {
            ...
            if ($this->configService->isAccessTokenExpired()) {
                ...
                } catch (\CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\RefreshTokenExpiredException $e) {
            ...
            if (empty($token)) {
                ...
                throw new \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Exceptions\InvalidConfigurationException($message);
            }
        }
    ...
    private function refreshAccessToken()
    {
        ...
        $header = ['Authorization: Basic ' . $identity];

        $response = $this->getClient()->request('POST', $this->getTokenUrl(), $header, $payload);

        if (!$response->isSuccessful()) {
            throw new \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\RefreshTokenExpiredException(
        ...
        if (empty($result['access_token']) || empty($result['expires_in'])) {
            throw new \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpCommunicationException(
    ...
    private function logAndThrowHttpRequestException($message, $code = 0, $previousException = null)
    {
        ...
        throw new \CleverReach\CleverReachIntegration\IntegrationCore\Infrastructure\Utility\Exceptions\HttpRequestException(
            $message,
            $code,
            $previousException
        );
