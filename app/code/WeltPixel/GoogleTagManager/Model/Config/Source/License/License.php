...
namespace WeltPixel\Core\API\License;

/**
 * Class \WeltPixel\Core\API\License\LicenseAPI
 */
class LicenseAPI {

    const SECURE_KEY = '47946a777f205aafe421a61f8a83fb41';
    const SIGN_KEY   = '52dd8df5e427619f595d06b4c8b8e9f4';
    ...
    protected function getLicenseFilePath()
    {
        ...
        return $licenseDir . DIRECTORY_SEPARATOR . 'wlp-license';
    }
    ...
    protected function registerLicense($serverSign, $serverData)
    {
        ...
        $result = @file_get_contents('https://license.weltpixel.org/api/sign/', false, $context);
